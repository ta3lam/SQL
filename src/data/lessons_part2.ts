    ...
    exercises: [
      {
        ...
        checkFunction: (_r, q = '') => /UPDATE\s+orders/i.test(q) && /processing/i.test(q) && /id\s*=\s*11/i.test(q),
      },
      {
        id: 2,
        ...
        checkFunction: (_r, q = '') => /UPDATE\s+products/i.test(q) && /BookHouse/i.test(q),
      },
      {
        id: 3,
        ...
        checkFunction: (_r, q = '') => /UPDATE\s+customers/i.test(q) && /Silver/i.test(q) && /id\s*=\s*4/i.test(q),
      },
    ],
  },
    ...
    exercises: [
      {
        ...
        checkFunction: (_r, q = '') => /DELETE\s+FROM\s+orders/i.test(q) && /cancelled/i.test(q),
      },
      {
        id: 2,
        ...
        checkFunction: (_r, q = '') => /DELETE\s+FROM\s+products/i.test(q) && /is_available\s*=\s*0/i.test(q),
      },
    ],
  },
    ...
    exercises: [
      {
        ...
        checkFunction: (result, q = '') => result.length > 0 && /SUM/i.test(q) && /FROM\s+orders\b/i.test(q),
      },
      {
        id: 2,
        ...
        checkFunction: (result, q = '') => result.length > 0 && /COUNT|SUM|AVG|MIN|MAX/i.test(q) && /FROM\s+employees\b/i.test(q),
      },
      {
        id: 3,
        ...
        checkFunction: (result, q = '') => result.length > 0 && /COUNT/i.test(q) && /DISTINCT/i.test(q),
      },
    ],
  },
    ...
    exercises: [
      {
        ...
        checkFunction: (result, q = '') => result.length > 0 && /GROUP\s+BY/i.test(q) && /FROM\s+employees\b/i.test(q),
      },
      {
        id: 2,
        ...
        checkFunction: (result, q = '') => result.length > 0 && /GROUP\s+BY/i.test(q) && /FROM\s+orders\b/i.test(q),
      },
      {
        id: 3,
        ...
        checkFunction: (result, q = '') => result.length > 0 && /GROUP\s+BY/i.test(q) && /FROM\s+products\b/i.test(q),
      },
    ],
  },
    ...
    exercises: [
      {
        ...
        checkFunction: (result, q = '') => result.length > 0 && /HAVING/i.test(q) && /GROUP\s+BY/i.test(q),
      },
      {
        id: 2,
        ...
        checkFunction: (result, q = '') => result.length > 0 && /HAVING/i.test(q) && /GROUP\s+BY/i.test(q) && /FROM\s+orders\b/i.test(q),
      },
      {
        id: 3,
        ...
        checkFunction: (result, q = '') => result.length > 0 && /HAVING/i.test(q) && /BETWEEN/i.test(q),
      },
    ],
  },
    ...
    exercises: [
      {
        ...
        checkFunction: (result, q = '') => result.length > 0 && /JOIN\s+customers\b/i.test(q) && /FROM\s+orders\b/i.test(q),
      },
      {
        id: 2,
        ...
        checkFunction: (result, q = '') => result.length > 0 && /JOIN\s+products\b/i.test(q) && /FROM\s+order_items\b/i.test(q),
      },
    ],
  },
    ...
    exercises: [
      {
        ...
        checkFunction: (result, q = '') => result.length > 0 && /JOIN\s+departments\b/i.test(q) && /FROM\s+employees\b/i.test(q),
      },
      {
        id: 2,
    ...
    exercises: [
      {
        ...
        checkFunction: (result, q = '') => result.length > 0 && /LEFT\s+JOIN\s+orders\b/i.test(q) && /FROM\s+customers\b/i.test(q),
      },
      {
        id: 2,
        ...
        checkFunction: (result, q = '') => result.length > 0 && /LEFT\s+JOIN\s+order_items\b/i.test(q) && /IS\s+NULL/i.test(q),
      },
    ],
  },
    ...
    exercises: [
      {
        ...
        checkFunction: (result, q = '') => result.length > 0 && /CROSS\s+JOIN/i.test(q),
      },
    ],
  },
    ...
    exercises: [
      {
        ...
        checkFunction: (result, q = '') => result.length > 0 && /JOIN\s+employees\b/i.test(q) && /manager_id/i.test(q),
      },
      {
        id: 2,
        ...
        checkFunction: (result, q = '') => result.length > 0 && /JOIN\s+employees\b/i.test(q) && /manager_id/i.test(q) && /salary/i.test(q),
      },
    ],
  },
];
