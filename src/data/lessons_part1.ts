    ...
    exercises: [
      {
        ...
        checkFunction: (result, q = '') => result.length > 0 && /FROM\s+employees\b/i.test(q),
      },
      {
        id: 2,
        ...
        checkFunction: (result, q = '') => result.length > 0 && /FROM\s+products\b/i.test(q),
      },
    ],
  },
    ...
    exercises: [
      {
        ...
        checkFunction: (result, q = '') => result.length > 0 && /FROM\s+orders\b/i.test(q) && /LIMIT/i.test(q),
      },
      {
        id: 2,
        ...
        checkFunction: (result, q = '') => result.length > 0 && /FROM\s+categories\b/i.test(q),
      },
    ],
  },
    ...
    exercises: [
      {
        ...
        checkFunction: (result, q = '') => result.length > 0 && /CAST/i.test(q) && /FROM\s+products\b/i.test(q),
      },
      {
        id: 2,
        ...
        checkFunction: (result, q = '') => result.length > 0 && /IS\s+NULL/i.test(q) && /FROM\s+employees\b/i.test(q),
      },
    ],
  },
    ...
    exercises: [
      {
        ...
        checkFunction: (result, q = '') => result.length > 0 && /name/i.test(q) && /price/i.test(q) && /stock_quantity/i.test(q) && /FROM\s+products\b/i.test(q),
      },
      {
        id: 2,
        ...
        checkFunction: (result, q = '') => result.length > 0 && /discounted_price/i.test(q) && /FROM\s+products\b/i.test(q),
      },
      {
        id: 3,
        ...
        checkFunction: (result, q = '') => result.length > 0 && /DISTINCT/i.test(q) && /FROM\s+customers\b/i.test(q),
      },
    ],
  },
    ...
    exercises: [
      {
        ...
        checkFunction: (result, q = '') => result.length > 0 && /FROM\s+products\b/i.test(q) && /price/i.test(q),
      },
      {
        id: 2,
        ...
        checkFunction: (result, q = '') => result.length > 0 && /FROM\s+orders\b/i.test(q) && /status/i.test(q),
      },
      {
        id: 3,
        ...
        checkFunction: (result, q = '') => result.length > 0 && /FROM\s+customers\b/i.test(q) && /IS\s+NULL/i.test(q),
      },
      {
        id: 4,
        ...
        checkFunction: (result, q = '') => result.length > 0 && /FROM\s+employees\b/i.test(q) && /hire_date/i.test(q),
      },
    ],
  },
    ...
    exercises: [
      {
        ...
        checkFunction: (result, q = '') => result.length > 0 && /ORDER\s+BY/i.test(q) && /price/i.test(q),
      },
      {
        id: 2,
        ...
        checkFunction: (result, q = '') => result.length > 0 && /ORDER\s+BY/i.test(q) && /department_id/i.test(q),
      },
      {
        id: 3,
        ...
        checkFunction: (result, q = '') => result.length > 0 && /ORDER\s+BY/i.test(q) && /joined_date/i.test(q),
      },
    ],
  },
    ...
    exercises: [
      {
        ...
        checkFunction: (result, q = '') => result.length > 0 && /FROM\s+employees\b/i.test(q) && /AND/i.test(q) && /salary/i.test(q),
      },
      {
        id: 2,
        ...
        checkFunction: (result, q = '') => result.length > 0 && /FROM\s+orders\b/i.test(q) && /OR/i.test(q) && /status/i.test(q),
      },
      {
        id: 3,
        ...
        checkFunction: (result, q = '') => result.length > 0 && /FROM\s+products\b/i.test(q) && /OR/i.test(q),
      },
    ],
  },
    ...
    exercises: [
      {
        ...
        checkFunction: (result, q = '') => result.length > 0 && /LIKE/i.test(q) && /FROM\s+customers\b/i.test(q),
      },
      {
        id: 2,
        ...
        checkFunction: (result, q = '') => result.length > 0 && /LIKE/i.test(q) && /FROM\s+products\b/i.test(q),
      },
      {
        id: 3,
        ...
        checkFunction: (result, q = '') => result.length > 0 && /LIKE/i.test(q) && /FROM\s+employees\b/i.test(q),
      },
    ],
  },
    ...
    exercises: [
      {
        ...
        checkFunction: (result, q = '') => result.length > 0 && /\bIN\s*\(/i.test(q) && /FROM\s+employees\b/i.test(q),
      },
      {
        id: 2,
        ...
        checkFunction: (result, q = '') => result.length > 0 && /BETWEEN/i.test(q) && /FROM\s+products\b/i.test(q),
      },
      {
        id: 3,
        ...
        checkFunction: (result, q = '') => result.length > 0 && /NOT\s+IN/i.test(q) && /FROM\s+customers\b/i.test(q),
      },
    ],
  },
    ...
    exercises: [
      {
        ...
        checkFunction: (_r, q = '') => /department_id\s+IS\s+NULL/i.test(q),
      },
      {
        id: 2,
        ...
        checkFunction: (result, q = '') => result.length > 0 && /COALESCE|IFNULL/i.test(q),
      },
      {
        id: 3,
        question: 'Count how many orders have notes (notes IS NOT NULL).',
        questionAr: 'اعدد كم طلباً يحتوي على ملاحظات (notes IS NOT NULL).',
        hint: 'Use COUNT with WHERE notes IS NOT NULL',
        hintAr: 'استخدم COUNT مع WHERE notes IS NOT NULL',
        expectedQuery: 'SELECT COUNT(*) FROM orders WHERE notes IS NOT NULL',
        checkFunction: (result, q = '') => result.length > 0 && /COUNT/i.test(q) && /IS\s+NOT\s+NULL/i.test(q),
      },
    ],
  },
    ...
    exercises: [
      {
        ...
        checkFunction: (result, q = '') => result.length > 0 && /LIMIT/i.test(q) && /ORDER\s+BY/i.test(q) && /FROM\s+products\b/i.test(q),
      },
      {
        id: 2,
      ...
      },
      {
        ...
        checkFunction: (result, q = '') => result.length > 0 && /LIMIT/i.test(q) && /OFFSET/i.test(q),
      },
    ],
  },
    ...
    exercises: [
      {
        ...
        checkFunction: (_r, q = '') => /CREATE\s+TABLE\s+(?:IF\s+NOT\s+EXISTS\s+)?skills\b/i.test(q),
      },
      {
        id: 2,
        ...
        checkFunction: (_r, q = '') => /CREATE\s+TABLE\s+products_backup\s+AS\s+SELECT/i.test(q),
      },
    ],
  },
    ...
    exercises: [
      {
        ...
        checkFunction: (_r, q = '') => /CREATE\s+TABLE\s+(?:IF\s+NOT\s+EXISTS\s+)?coupons\b/i.test(q) && /CHECK/i.test(q),
      },
    ],
  },
    ...
    exercises: [
      {
        ...
        checkFunction: (_r, q = '') => /ALTER\s+TABLE\s+employees\s+ADD\s+COLUMN\s+middle_name/i.test(q),
      },
      {
        id: 2,
        ...
        checkFunction: (_r, q = '') => /DROP\s+TABLE\s+(?:IF\s+EXISTS\s+)?temp_products/i.test(q),
      },
    ],
  },
    ...
    exercises: [
      {
        ...
        checkFunction: (_r, q = '') => /INSERT\s+INTO\s+customers/i.test(q) && /Test\s+Customer/i.test(q),
      },
      {
        id: 2,
        ...
        checkFunction: (_r, q = '') => /INSERT\s+INTO\s+products/i.test(q) && /Webcam\s+HD/i.test(q) && /USB\s+Microphone/i.test(q),
      },
    ],
  },
];
