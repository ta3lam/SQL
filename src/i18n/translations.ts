...
export const translations: Record<Lang, Translations> = {
  en: {
    ...
    dvdLevels: [
      ...
      'Level 15 — Performance & Transactions',
      'Level 16 — Advanced SQL Mastery',
      'Level 17 — Real-World Projects',
    ],
    // Mark as complete
  ...
  ar: {
    ...
    dvdLevels: [
      ...
      'المستوى 10 — تصفية مركّبة',
      'المستوى 11 — DDL: بناء الجداول',
      'المستوى 12 — DML: تعديل البيانات',
      'المستوى 13 — JOINs تفصيلي',
      'المستوى 14 — عمليات المجموعات والمناظير',
      'المستوى 15 — الأداء والمعاملات',
      'المستوى 16 — إتقان SQL المتقدم',
      'المستوى 17 — مشاريع واقعية',
    ],
    // Mark as complete
